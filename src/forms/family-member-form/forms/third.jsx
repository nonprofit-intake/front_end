		...
		<form className="multi-form-container">
			<div className="text-fields-container-multiform">
				...
				{formValues.in_school == 'yes' && (
					<div className="text-fields-container-multiform">
						<div>
							<FormLabel component="legend">Connected with McKinney- Vento School</FormLabel>
							<RadioGroup
								onChange={handleChange}
								aria-label="gender"
								name="connected_to_MVento"
								value={formValues.connected_to_MVento}
								onChange={handleChange}
							>
								<FormControlLabel value="yes" control={<Radio />} label="Yes" />
								<FormControlLabel value="no" control={<Radio />} label="No" />
						...
						<div className="input-with-label">
							...
							<TextField
								value={formValues.school_status}
								onChange={handleChange}
								name="gender"
								id="select"
								select
