...
const AddMemberForm = () => {
    ...
    const handleSubmit = () => {
        axiosWithAuth().post(`/api/guests/family/${params.fam_id}`, formValues).then(res => {
        ...
        <div>
            <div className='add-member-container'>
                <div className='forms-container'>
                    <MultStepForm setFormValues={setFormValues} formValues={formValues} handleChange={handleChange} activeStep={activeStep}></MultStepForm>
                </div>
